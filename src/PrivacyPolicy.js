    ...
    <div style={{ background: '#0A0A0F', minHeight: '100vh', padding: '40px 20px', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', color: COLORS.textMuted, lineHeight: 1.8 }}>
        ...
        {[
          ...
          { title: '5. Data Sharing', content: 'We do not sell your personal information. We may share it only with other Link-AP users (to the extent your profile is visible), service providers such as Firebase (database, authentication, and push notifications) and Anthropic (to generate personalised AI match explanations — your professional profile information such as your role, skills, and what you are looking for is processed by Anthropic\'s API for this purpose), or if required by law.' },
