    ...
    <div style={{ minHeight: "100vh", background: COLORS.bg, maxWidth: 430, margin: "0 auto", position: "relative" }}>
      ...
      <div style={{ paddingBottom: 90 }}>
        {tab === "discover" && !!(user.bio && user.skills?.length > 0 && user.lookingFor?.length > 0 && user.photoURL) === false && (
          <div onClick={() => setTab("profile")} style={{
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 700, color: COLORS.accent }}>Complete your profile</div>
              <div style={{ fontSize: 12, color: COLORS.textMuted, marginTop: 2 }}>Add bio, skills & photo to get better connections</div>
            </div>
      ...
      <div style={{
        ...
        {[
          ...
          { id: "pulse", label: "Ideas",
            icon: c => <svg viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="22" height="22"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 0 1 8.91 14"/></svg> },
