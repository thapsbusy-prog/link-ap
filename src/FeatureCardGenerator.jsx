  ...
  "Cash Flow Projection": [
    {
      ...
      what: "12-Month Cash Flow Projection Builder",
      whatDesc: "Set a starting cash balance, revenue, and expense assumptions, and Link-Ap builds an editable 12-month cash flow forecast — tap into any month to override it, watch the balance and totals recompute live, then download or WhatsApp the polished PDF.",
      ...
      example: "You're applying for a small business loan and need a forecast attached. You set your assumptions, then manually bump month 6's revenue to reflect a contract you've already signed — the ending balance and lowest point update instantly, and you download the PDF straight into your application.",
    },
    {
      pill: "CASH FLOW PROJECTION",
      what: "12-Month Cash Flow Projection Builder",
      ...
      example: "You're 3 months from launch and modelling your first year. The projection flags month 5 as your tightest point — comfortably before it happens, giving you time to line up a buffer instead of discovering the gap when it's already overdue.",
    },
    {
      pill: "CASH FLOW PROJECTION",
      what: "12-Month Cash Flow Projection Builder",
      ...
      example: "Your business partner is overseas and wants visibility on the next year's cash position. You build the projection, share the PDF straight to your WhatsApp group, and walk through the lowest-point month on a call.",
    },
  ],
