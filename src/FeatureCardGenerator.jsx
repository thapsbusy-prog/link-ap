...
const FEATURE_CARDS = {
  ...
  "Cash Flow Projection": [
    {
      pill: "CASH FLOW PROJECTION",
      what: "12-Month Cash Flow Statement Builder",
      whatDesc: "Add your own line items — Rent, Electricity, Interest, Product Sales, anything — and Link-Ap lays them out in a real 12-month cash flow statement, with totals, net cash flow, and a running balance recomputed live as you edit any month, then download or WhatsApp the polished PDF.",
      forWhom: "Founders Pitching Investors or a Bank",
      forDesc: "A credible 12-month forecast is often the first thing an investor or loan officer asks for. Now you can build one in minutes, tweak any month by hand, and hand over a clean PDF instead of a spreadsheet screenshot.",
      example: "You're applying for a small business loan and need a forecast attached. You list out Rent, Salaries, Stock, and Loan Interest as separate expense lines next to your Product Sales revenue line — the ending balance and lowest point update instantly as you fill in each month, and you download the PDF straight into your application.",
    },
    {
      pill: "CASH FLOW PROJECTION",
      what: "12-Month Cash Flow Statement Builder",
      whatDesc: "Add your own line items — Rent, Electricity, Interest, Product Sales, anything — and Link-Ap lays them out in a real 12-month cash flow statement, with totals, net cash flow, and a running balance recomputed live as you edit any month, then download or WhatsApp the polished PDF.",
      forWhom: "New Business Owners Planning Their First Year",
      forDesc: "Most first-year cash flow problems aren't a surprise in hindsight — they're a month nobody modelled. Seeing all 12 months laid out, with the lowest point flagged, catches the squeeze before it happens.",
      example: "You're 3 months from launch and modelling your first year. You add Rent, Electricity, and Stock as expense lines and Product Sales as revenue — the statement flags month 5 as your tightest point, comfortably before it happens, giving you time to line up a buffer instead of discovering the gap when it's already overdue.",
    },
    {
      pill: "CASH FLOW PROJECTION",
      what: "12-Month Cash Flow Statement Builder",
      whatDesc: "Add your own line items — Rent, Electricity, Interest, Product Sales, anything — and Link-Ap lays them out in a real 12-month cash flow statement, with totals, net cash flow, and a running balance recomputed live as you edit any month, then download or WhatsApp the polished PDF.",
      forWhom: "Small Business Owners Sharing Numbers With a Partner",
      forDesc: "Talking through cash flow with a co-founder, accountant, or family member is easier with a document in hand than a verbal estimate. Share the PDF straight to WhatsApp and talk through it together.",
      example: "Your business partner is overseas and wants visibility on the next year's cash position. You build the statement with your actual expense lines — Rent, Electricity, Interest — share the PDF straight to your WhatsApp group, and walk through the lowest-point month on a call.",
    },
  ],
